...
# Function to append a new location to Google Sheets
  ...
  observeEvent(input$submit, {
    ...
    if (!is.null(marker_pos)) {
      withProgress(
        ...
        value = 0.5,
        {
          # Append the new location and refresh the dataset
      ...
      showNotification(
        "Please drag the marker to your location before submitting.",
        type = "error",
        duration = 3
      )
    }

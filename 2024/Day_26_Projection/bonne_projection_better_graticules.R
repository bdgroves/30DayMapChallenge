...
# Plot the Bonne projection map with projected graticules
ggplot() +
  geom_sf(data = graticules, color = "gray60", linetype = "dashed", size = 0.3) +  # Graticules
  ...
  labs(title = "Bonne Projection with Properly Projected Graticules")
